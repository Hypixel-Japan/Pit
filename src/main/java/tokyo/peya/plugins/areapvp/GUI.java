...
public class GUI implements Listener
{
    ...
    private void onPickUp(InventoryClickEvent e)
    {
        ...
        if (tokyo.peya.plugins.areapvp.Items.hasMetadata(item, "notBuyable"))
        {
        ...
        switch (type)
        {
            case "item":
                if (!e.getClickedInventory().getName().equals(ChatColor.BLUE + "Item Shop"))
                    return;
                IShopItem shopItem = Items.getItem(tokyo.peya.plugins.areapvp.Items.getMetadata(item, "type"));
            ...
            case "perk":
                ...
                String ty;
                if ((ty = tokyo.peya.plugins.areapvp.Items.getMetadata(item, "slot")) == null)
                    return;
                ...
                {
                    IPerkEntry entry = Perks.getPerk(tokyo.peya.plugins.areapvp.Items.getMetadata(item, "type"));
            ...
            case "firstPerk":
                ...
                Long v;
                if ((v = PitDebug.parseLong(tokyo.peya.plugins.areapvp.Items.getMetadata(item, "perkSlot"))) == null)
                    return;
